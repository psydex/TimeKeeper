package com.apps.timekeeper.db;
...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
	...
	private static final String DATABASE_NAME = "timekeeper.db";
	...
	private RuntimeExceptionDao<Job, Integer> simpleRuntimeDao = null;
	 ...
	 */
	public RuntimeExceptionDao<Job, Integer> getJobDao() {
		if (simpleRuntimeDao == null) {
			simpleRuntimeDao = getRuntimeExceptionDao(Job.class);
		}
